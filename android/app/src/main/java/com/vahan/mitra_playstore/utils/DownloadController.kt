...
class DownloadController(
    private val earnFragmentV2: EarnFragmentV2,
    private val context: Context,
    private val url: String
) {
    companion object {
        private const val FILE_NAME = "app-prod.apk"
...
//            .show()
//        earnFragmentV2.showProgressDialogWithTitle(
//            "App is updating!",
//            "Please wait while we bring in the latest features and a smoother experience for you.."
//        )
    ...
    private fun showInstallOption(
        ...
        val onComplete = object : BroadcastReceiver() {
            override fun onReceive(
             ...
             //   earnFragmentV2.hideProgressDialogWithTitle()
