        ...
        holder.binding.apply {
            if(data.incentiveList[pos].milestones[position].achieved=="COMPLETED"){
               ...
               // seekbar1.visibility = View.GONE
                ...
                if (  position<data.incentiveList[pos].milestones.size-1 && data.incentiveList[pos].milestones[position+1].achieved=="IN_PROGRESS") {
            ...
            } else if(data.incentiveList[pos].milestones[position].achieved=="IN_PROGRESS"){
